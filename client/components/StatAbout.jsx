    ...
    <section className="stat-about" ref={sectionRef}>
      <div className="stat-about__container">
            ...
            <div className="stat-about__image-item stat-about__image-item--card">
              ...
              <div className="stat-about__team-avatars">
                <div className="stat-about__avatar">
                  <Image src="/images/imagetrail/image1.jpg" alt="Team member" width={40} height={40} />
                </div>
                <div className="stat-about__avatar">
                  <Image src="/images/imagetrail/image2.jpg" alt="Team member" width={40} height={40} />
                </div>
                <div className="stat-about__avatar">
                  <Image src="/images/imagetrail/image3.jpg" alt="Team member" width={40} height={40} />
                </div>
                <div className="stat-about__avatar">
                  <Image src="/images/imagetrail/image4.jpg" alt="Team member" width={40} height={40} />
                </div>
        ...
        <div className="stat-about__right">
          ...
          {/* CTA Button */}
          <Link href="/book-call" className="stat-about__cta">
            JOIN OUR NETWORK
          </Link>
        </div>
      </div>
