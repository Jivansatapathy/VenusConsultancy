...
export const sendOTPEmail = async (email, otp) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER || 'satapathyjjivan@gmail.com',
      to: email,
      subject: 'Admin Login Verification Code - Venus Hiring',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #dc2626; border-bottom: 2px solid #dc2626; padding-bottom: 10px;">
          ...
          <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #3b82f6;">
            ...
            <p style="font-size: 16px; color: #333; margin: 10px 0;">
              A login attempt was made to your admin account. Please use the following code to complete your login:
            </p>
            <div style="background: #ffffff; border: 2px dashed #3b82f6; border-radius: 8px; padding: 20px; text-align: center; margin: 20px 0;">
              <p style="font-size: 32px; font-weight: bold; color: #dc2626; letter-spacing: 8px; margin: 0;">
                ${otp}
              </p>
            </div>
          ...
          <div style="background: #fef3c7; padding: 15px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #f59e0b;">
            <p style="margin: 0; color: #92400e; font-size: 14px;">
              <strong>⚠️ Security Notice:</strong> If you did not attempt to login, please ignore this email and consider changing your password immediately.
            </p>
          </div>
          
          <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 30px 0;">
          <p style="color: #6b7280; font-size: 12px; text-align: center;">
            This email was sent from the Venus Hiring admin login system.<br>
      ...
      text: `
        ...
        Security Notice: If you did not attempt to login, please ignore this email and consider changing your password immediately.
        
        ---
        This email was sent from the Venus Hiring admin login system.
        Please do not share this code with anyone.
      `
    };
