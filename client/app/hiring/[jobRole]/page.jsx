...
import { getJobRoleByKey, getAllIndustries, getJobRolesByIndustry } from "../../../src/data/jobRolesData";
import "../../../src/pages/Hiring.css";

export default function HiringPage({ params }) {
  const { jobRole } = params;
            ...
            <div className="hiring-content">
              ...
              <div className="hiring-cta">
                ...
                <div className="cta-actions">
                  <Link href="/job-roles" className="btn btn-outline">Browse All Job Roles</Link>
            ...
            <div className="positions-table">
              ...
              {relatedPositions.map((position, index) => (
                <div key={index} className="table-row">
                  {position.key ? (
                    <Link href={`/hiring/${position.key}`} className="position-title">{position.title}</Link>
                  ) : (
