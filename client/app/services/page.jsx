...
const Services = () => {
  ...
  const services = [
    {
      ...
      links: [
        "Sales", "Marketing", "Market Research", "Regulatory Affairs", "Supply Chain Management",
        "Clinical Trials Assistant", "Clinical Research", "Business Development", "Legal",
        "Chemical Engineering", "Laboratory Support", "Quality Control", "Pharmacology",
      ],
    },
    {
      title: "C-suite Executive Search",
      links: [
        "Board Search", "Chief Executive Officer (CEO)", "Chief Financial Officer (CFO)",
        "Chief Operations Officer (COO)", "Chief Marketing Officer (CMO)", "Chief Technology Officer (CTO)",
        "Chief Information Officer (CIO)", "Chief Human Resources Officer (CHRO)",
        "Chief Risk Officer (CRO)", "Chief Strategy Officer (CSO)", "General Manager", "Country Manager",
      ],
    },
    {
      title: "Aerospace",
      links: [
        "Control System Engineer", "Software Quality Engineer", "System Engineer", "Technical Project Manager",
        "Embedded Software Engineer", "Aerospace Engineer", "Flight Test Engineer", "Avionics Engineer",
        "Structural Engineer", "Propulsion Engineer", "Systems Integration Engineer", "DO-178 Certification Experts",
      ],
    },
    {
      title: "AutoTech",
      links: [
        "Software Testing", "Embedded Software Developer", "Technical Project Manager",
        "Validation, Verification & Integration Testing", "Autonomous Vehicle System", "ADAS Engineers",
        "Mechanical Developers", "Software/Hardware Design", "Embedded Developers", "QA Engineers",
        "FuSa / Cybersecurity", "Infotainment Developers",
      ],
    },
    {
      title: "Manufacturing & Skilled Trade",
      links: [
        "Engineering", "Manufacturing", "Supply Chain", "Logistics", "Transportation", "Construction",
        "Procurement", "3PL", "Health & Safety", "Quality", "Production", "Distribution", "Trades",
        "Lean Six Sigma", "Warehousing", "Project Management", "Process Improvement",
        "Business & Strategic Planning", "Facilities Management", "Pharmaceuticals",
        "Consumer Packaged Goods", "Industrial", "Life Sciences",
      ],
    },
    {
      title: "Accounting & Back Office Outsourcing",
      links: [
        "CFO", "VP Finance", "Controller", "AP / AR Clerk", "Staff Accountant", "Intermediate Accountant",
        "Accounting Technician", "Sr. Accountant", "Sr. Accountant — Audit & Assurance",
        "Manager — Audit & Assurance", "Sr. Manager — Audit & Assurance", "Tax Technician",
        "Sr. Accountant — Tax", "Tax Specialist", "Manager — Tax", "Sr. Manager — Tax",
        "Valuations Specialist", "Manager — Valuations", "Sr. Manager — Valuations",
        "Manager — Professional Services", "Sr. Manager — Professional Services", "Tax Partner", "Audit Partner",
      ],
    },
    {
      ...
      links: [
        ...
        "DevOps Engineer", "Cloud Architect", "Data Engineer", "Machine Learning Engineer", "AI Specialist",
        "Cybersecurity Analyst", "IT Support Specialist", "System Administrator", "Network Engineer",
        "Database Administrator", "QA Engineer", "Test Automation Engineer", "Technical Writer",
        "Solution Architect", "Product Owner", "Scrum Master", "Agile Coach", "Technical Lead",
    ...
    },
    {
      ...
      links: [
        "Physician", "Nurse Practitioner", "Registered Nurse", "Licensed Practical Nurse", "Medical Assistant",
        "Physician Assistant", "Pharmacist", "Pharmacy Technician", "Medical Technologist",
        "Radiology Technician", "Laboratory Technician", "Physical Therapist", "Occupational Therapist",
        "Speech Therapist", "Respiratory Therapist", "Medical Social Worker", "Healthcare Administrator",
        "Medical Billing Specialist", "Health Information Manager", "Clinical Research Coordinator",
        "Medical Device Specialist", "Healthcare IT Specialist", "Telemedicine Coordinator", "Patient Care Coordinator",
      ],
    },
    {
      title: "Finance & Banking",
      links: [
        "Investment Banker", "Financial Analyst", "Portfolio Manager", "Risk Manager", "Credit Analyst",
        "Loan Officer", "Mortgage Specialist", "Insurance Agent", "Actuary", "Compliance Officer",
        "Anti-Money Laundering Specialist", "Treasury Analyst", "Corporate Finance Manager",
        "Mergers & Acquisitions Specialist", "Private Equity Associate", "Hedge Fund Manager",
        "Financial Planner", "Wealth Manager", "Tax Advisor", "Audit Manager", "Financial Controller",
        "Treasury Manager", "Capital Markets Specialist", "Fintech Specialist",
      ],
    },
    {
      title: "Sales & Business Development",
      links: [
        "Sales Representative", "Account Executive", "Sales Manager", "Regional Sales Director", "VP of Sales",
        "Business Development Manager", "Partnership Manager", "Channel Sales Manager",
        "Inside Sales Representative", "Outside Sales Representative", "Sales Engineer",
        "Customer Success Manager", "Account Manager", "Key Account Manager", "Sales Operations Manager",
        "Sales Analyst", "Lead Generation Specialist", "Sales Trainer", "Territory Manager",
        "Retail Sales Manager", "E-commerce Sales Manager", "International Sales Manager",
        "Sales Consultant", "Revenue Operations Manager",
      ],
    },
    {
      title: "Human Resources & Talent",
      links: [
        "HR Generalist", "HR Manager", "HR Director", "CHRO", "Recruiter", "Senior Recruiter",
        "Talent Acquisition Manager", "Head of Talent", "HR Business Partner", "Compensation Analyst",
        "Benefits Administrator", "Employee Relations Specialist", "Training & Development Manager",
        "Organizational Development Specialist", "HRIS Specialist", "Payroll Specialist", "HR Coordinator",
        "Talent Development Manager", "Diversity & Inclusion Manager", "HR Analytics Specialist",
        "Workplace Culture Manager", "Employee Engagement Specialist", "HR Consultant", "People Operations Manager",
      ],
    },
    {
      title: "Marketing & Communications",
      links: [
        "Marketing Manager", "Marketing Director", "CMO", "Digital Marketing Specialist",
        "Content Marketing Manager", "Social Media Manager", "SEO Specialist", "PPC Specialist",
        "Email Marketing Manager", "Brand Manager", "Product Marketing Manager", "Marketing Analyst",
        "Marketing Automation Specialist", "Growth Marketing Manager", "Performance Marketing Manager",
        "Public Relations Manager", "Communications Manager", "Content Creator", "Copywriter",
        "Graphic Designer", "Video Producer", "Marketing Operations Manager", "Campaign Manager", "Marketing Consultant",
      ],
    },
  ];
  ...
  const ServiceCard = ({ title, links }) => {
    ...
    const getJobRoleKey = (roleName) => {
      if (jobRolesData[roleName]) return roleName;
      for (const [key, jobData] of Object.entries(jobRolesData)) {
        if (jobData.title === roleName) return key;
      }
    ...
    return (
      <article className="svc-card">
        ...
        {serviceCategoryKey ? (
          <Link href={`/service-category/${serviceCategoryKey}`} className="svc-card__title-link">
        ...
        <ul className="svc-card__links">
          {visible.map((label) => {
            ...
            return jobRoleKey ? (
              <li key={label}>
                <Link href={`/hiring/${jobRoleKey}`} className="svc-card__link">
                  {label}
                </Link>
              </li>
            ) : (
